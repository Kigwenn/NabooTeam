...
//───── Methodes ─────────────────────────────────────────────────
	...
	System.out.println("");
	System.out.println("\t\t  ┌──────────────────────────┐");
	System.out.println("\t\t  │     Nouvelle Matieres    │");
	System.out.println("\t\t  └──────────────────────────┘\n");
	...
	String query = "INSERT INTO matiere (mat_nom) VALUES (?) RETURNING mat_id;";
	...
	public boolean listeMatieres(){
	    
	    String query = "SELECT mat_id, mat_nom";
	    query +=" FROM matiere";
	    ...
	    try {
		    ...
		    while(result.next()) {
			    i+=1;
			    System.out.print("│ "+i+"\t │  "+result.getString("mat_id"));	
	...
	public boolean supprMatieres(){
		...
		System.out.println("");
		System.out.println("\t\t  ┌───────────────────────┐");
		System.out.println("\t\t  │ SUPPRIMER UNE MATIERE │");
		System.out.println("\t\t  └───────────────────────┘\n");
				
		System.out.print("\t\t    ID : ");
		int id = sc.nextInt();
		
		String query = "DELETE FROM matiere WHERE mat_id=?;";
