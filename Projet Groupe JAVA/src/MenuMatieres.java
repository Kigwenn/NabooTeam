...
public class MenuMatieres extends Matieres {
...
//───── Methodes ─────────────────────────────────────────────────	
	...
	public void menuFull() {
		...
		if(dro_id == 1){
			...
			System.out.println("           ├───                               ──┤");
			System.out.println("           │            MENU Matieres           │");
			System.out.println("           ├──────                        ──────┤");
			System.out.println("           │                                    │");			

			if (dro_id == 1){
				System.out.println("           │  1) - Liste des Matieres           │");
				System.out.println("           │                                    │");
			}
			
			if (dro_id == 1){
				System.out.println("           │  2) - Créer une Matieres           │");
				System.out.println("           │                                    │");
			}
			
			if (dro_id == 1){
				System.out.println("           │  3) - Supprimer une Matieres       │");
				System.out.println("           │                                    │");
			}
